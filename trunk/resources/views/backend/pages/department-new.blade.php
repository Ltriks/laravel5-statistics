...
@section('page_title')
<h1>添加科室<span class="middle-sep mg-x-10"></span><a href="{{ url('admin/department/all') }}" class="btn btn-info">返回列表</a>
</h1>
@stop
@section('content')
...
<div class="row">
  <form action="{{ url('admin/department/create') }}" method="post" accept-charset="utf-8" class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" name="name" class="form-control" placeholder="科室名称唯一" value="">
      </div>
    </div>
    <hr>
    <div class="form-group">
