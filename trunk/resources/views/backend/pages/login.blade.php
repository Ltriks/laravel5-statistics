...
<head>
    ...
    <script type="text/javascript">var baseurl = "{{ url('/') }}";var referer='{{Cache::get('referer')}}'</script>
    <!--[if lt IE 9]>
...
<body class="page-body login-page login-form-fall">
    <div class="login-container">
        ...
        <div class="login-form">
            <div class="login-content">
                <div class="form-login-error login_error">
                    <h3>登录失败</h3>
                    <p>用户名或密码错误</p>
                </div>
    ...
    <script src="{{asset('backend/js/login.js')}}?version=1.4.1" ></script>
