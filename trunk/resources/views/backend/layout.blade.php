...
<body class="page-body">
  <div class="page-container @if(isset($_COOKIE['sidebar_status']) && $_COOKIE['sidebar_status'] == 'hide') sidebar-collapsed @endif">
    ...
    <div class="main-content container">
      <div class="row">
        ...
        <div class="col-md-6 col-sm-4 clearfix hidden-xs">
          <ul class="list-inline links-list pull-right">
            <li>
              <a href="javascript:void(0);" data-toggle="chat" data-animate="1" data-collapse-sidebar="1">{{ getUserInfo('name') }}</a>
            </li>
            <li class="sep"></li>
            <li>
      ...
      <!-- Footer -->
      <footer class="main">
        &copy; {{date('Y')}} <strong>GeekZooStudio</strong>
        Powered by
        <a href="javascript:void(0);" target="_blank">Power By GeekZooStudio</a>
      </footer>
    </div>
  </div>
